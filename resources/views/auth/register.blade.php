    ...
    <div class="mx-auto text-center mb-5 w-1/6">
        ...
        <div class="results">
            ...
            <div class="flex flex-col mb-4">
                ...
                <input class="form-input px-4 py-3 rounded-full border focus:outline-none focus:ring focus:border-blue-300" type="password" name="rpassword" placeholder="Repeat password">
            ...
            <div class="flex flex-col mb-4">
                ...
                <input class="form-input px-4 py-3 rounded-full border focus:outline-none focus:ring focus:border-blue-300" type="email" name="email" placeholder="Enter Email" value="{{ old('email') }}">
            ...
            <div class="flex flex-col mb-4">
                ...
                <input class="form-input px-4 py-3 rounded-full border focus:outline-none focus:ring focus:border-blue-300" type="text" name="fname" placeholder="Enter First Name" value="{{ old('fname') }}">
            ...
            <div class="flex flex-col mb-4">
                ...
                <input class="form-input px-4 py-3 rounded-full border focus:outline-none focus:ring focus:border-blue-300" type="text" name="lname" placeholder="Enter Last Name" value="{{ old('lname') }}">
